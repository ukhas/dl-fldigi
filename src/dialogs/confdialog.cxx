		...
		{ tabDL = new Fl_Tabs(0, 25, 500, 345);
          ...
          { tabDLConf = new Fl_Group(0, 50, 500, 320, _("Config"));
            { Fl_Group* o = new Fl_Group(5, 60, 490, 300);
              o->box(FL_ENGRAVED_FRAME);
              o->align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE);
              { Fl_Check_Button* o = dlchkAutoExtract = new Fl_Check_Button(10, 70, 20, 20, _("Enable detection && extraction"));
				...
				dlchkAutoExtract->align(FL_ALIGN_RIGHT);
          ...
          { tabDLRemote = new Fl_Group(0, 50, 500, 320, _("Remote"));
            { Fl_Group* o = new Fl_Group(5, 60, 490, 300);
              o->box(FL_ENGRAVED_FRAME);
              o->align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE);
			  { Fl_Check_Button* o = chkwfall_png = new Fl_Check_Button(10, 70, 20, 20, _("Save waterfall to png"));
				...
				chkwfall_png->align(FL_ALIGN_RIGHT);
